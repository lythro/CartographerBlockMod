...
public class CartographerBlockRenderer extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity te, double x, double y, double z,
		...
		// Use in 1.6.2 this
		ResourceLocation textures = (new ResourceLocation("cartoblock:textures/blocks/CartographerBlock.png"));
